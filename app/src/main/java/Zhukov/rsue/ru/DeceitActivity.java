...
public class DeceitActivity extends AppCompatActivity {
    public static final String EXTRA_ANSWER_IS_TRUE = "Zhukov.rsue.ru.driodquest.answer_is_true";
    public static final String EXTRA_ANSWER_SHOWN = "Zhukov.rsue.ru.driodquest.answer_is_shown";
